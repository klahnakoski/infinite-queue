...
from mo_sql import (
    ...
    SQL_CP,
    SQL_DOT,
    SQL_LT, SQL_SPACE, SQL_AS, SQL_LIMIT, SQL_UPDATE, SQL_SET)
...
def sql_create(table, properties, primary_key=None, unique=None, foreign_key=None):
    """
...
def id_generator(db, version_table):
    """
    :param db: THE DB TO ACT ON
    :param version_table:  THE id STATE IS STORED IN THE VERSION TABLE
    :return: FUNCTION THAT WILL GENERATE NEW IDS
    """
